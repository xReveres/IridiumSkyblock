...
public enum MultiversionMaterials {
    ...
    ACACIA_SIGN("ACACIA_WALL_SIGN", 0),
    ...
    ALLIUM("STONE", 0),
    ANDESITE("STONE", 5),
    ANDESITE_SLAB("ANDESITE_SLAB", 0),
    ANDESITE_STAIRS("ANDESITE_STAIRS", 0),
    ANDESITE_WALL("ANDESITE_WALL", 0),
    ANVIL("ANVIL", 0),
    APPLE("APPLE", 0),
    ...
    BAMBOO("BAMBOO", 0),
    BAMBOO_SAPLING("BAMBOO_SAPLING", 0),
    BARREL("BARREL", 0),
    BARRIER("BARRIER", 0),
    ...
    BEEF("RAW_BEEF", 0),
    BEEHIVE("BEEHIVE", 0),
    BEETROOT(Arrays.asList("BEETROOTS", "BEETROOT_BLOCK"), 0),
    BEETROOT_SEEDS("BEETROOT_SEEDS", 0),
    BEETROOT_SOUP("BEETROOT_SOUP", 0),
    BEE_NEST("BEE_NEST", 0),
    BEE_SPAWN_EGG("BEE_SPAWN_EGG", 0),
    BELL("BELL", 0),
    ...
    BRAIN_CORAL_WALL_FAN("BRAIN_CORAL_WALL_FAN", 0),
    BREAD("BREAD", 0),
    BREWING_STAND(Arrays.asList("BREWING_STAND", "BREWING_STAND_ITEM"), 0),
    BRICK("CLAY_BRICK", 0),
    BRICKS("BRICK", 0),
    BRICK_SLAB("STEP", 4),
    BRICK_STAIRS("BRICK_STAIRS", 0),
    BRICK_WALL("BRICK_WALL", 0),
    BROWN_BANNER("BANNER", 3),
    BROWN_BED("BED", 12),
    BROWN_CARPET("CARPET", 12),
    BROWN_CONCRETE("CONCRETE", 12),
    BROWN_CONCRETE_POWDER("CONCRETE_POWDER", 12),
    BROWN_DYE("BROWN_DYE", 0),
    ...
    BUBBLE_CORAL_WALL_FAN("BUBBLE_CORAL_WALL_FAN", 0),
    BUCKET("BUCKET", 0),
    CACTUS("CACTUS", 0),
    CAKE("CAKE_BLOCK", 0),
    CAMPFIRE("CAMPFIRE", 0),
    CARROT(Arrays.asList("CARROT", "CARROT_ITEM", "CARROTS"), 0),
    CARROT_ON_A_STICK("CARROT_STICK", 0),
    CARTOGRAPHY_TABLE("CARTOGRAPHY_TABLE", 0),
    CARVED_PUMPKIN("PUMPKIN", 0),
    CAT_SPAWN_EGG("CAT_SPAWN_EGG", 0),
    CAULDRON(Arrays.asList("CAULDRON", "CAULDRON_ITEM"), 0),
    CAVE_AIR("AIR", 0),
    ...
    COMPARATOR(Arrays.asList("REDSTONE_COMPARATOR", "REDSTONE_COMPARATOR_OFF", "REDSTONE_COMPARATOR_ON"), 0),
    COMPASS("COMPASS", 0),
    COMPOSTER("COMPOSTER", 0),
    CONDUIT("STONE", 0),
    ...
    CREEPER_BANNER_PATTERN("CREEPER_BANNER_PATTERN", 0),
    CREEPER_HEAD("SKULL", 0),
    CREEPER_SPAWN_EGG("MONSTER_EGG", 0),
    CREEPER_WALL_HEAD("SKULL", 0),
    CROSSBOW("CROSSBOW", 0),
    CUT_RED_SANDSTONE("STONE", 0),
    CUT_RED_SANDSTONE_SLAB("CUT_RED_SANDSTONE_SLAB", 0),
    CUT_SANDSTONE("STONE", 0),
    CUT_SANDSTONE_SLAB("CUT_SANDSTONE_SLAB", 0),
    ...
    CYAN_WALL_BANNER(Arrays.asList("WALL_BANNER", "STANDING_BANNER"), 0),
    CYAN_WOOL("WOOL", 9),
    ...
    DARK_OAK_SIGN("DARK_OAK_SIGN", 0),
    DARK_OAK_SLAB("WOOD_STEP", 0),
    DARK_OAK_STAIRS("DARK_OAK_STAIRS", 0),
    DARK_OAK_TRAPDOOR("TRAP_DOOR", 0),
    DARK_OAK_WALL_SIGN("DARK_OAK_WALL_SIGN", 0),
    DARK_OAK_WOOD("LOG_2", 1),
    DARK_PRISMARINE("PRISMARINE", 2),
    DARK_PRISMARINE_SLAB("STONE", 0),
    DARK_PRISMARINE_STAIRS("STONE", 0),
    DAYLIGHT_DETECTOR(Arrays.asList("DAYLIGHT_DETECTOR", "DAYLIGHT_DETECTOR_INVERTED"), 0),
    DEAD_BRAIN_CORAL("DEAD_BRAIN_CORAL", 0),
    DEAD_BRAIN_CORAL_BLOCK("STONE", 0),
    DEAD_BRAIN_CORAL_FAN("DEAD_BRAIN_CORAL_FAN", 0),
    DEAD_BRAIN_CORAL_WALL_FAN("DEAD_BRAIN_CORAL_WALL_FAN", 0),
    DEAD_BUBBLE_CORAL("DEAD_BUBBLE_CORAL", 0),
    DEAD_BUBBLE_CORAL_BLOCK("STONE", 0),
    DEAD_BUBBLE_CORAL_FAN("DEAD_BUBBLE_CORAL_FAN", 0),
    DEAD_BUBBLE_CORAL_WALL_FAN("DEAD_BUBBLE_CORAL_WALL_FAN", 0),
    DEAD_BUSH("DEAD_BUSH", 0),
    DEAD_FIRE_CORAL("DEAD_FIRE_CORAL", 0),
    DEAD_FIRE_CORAL_BLOCK("STONE", 0),
    DEAD_FIRE_CORAL_FAN("DEAD_FIRE_CORAL_FAN", 0),
    DEAD_FIRE_CORAL_WALL_FAN("DEAD_FIRE_CORAL_WALL_FAN", 0),
    DEAD_HORN_CORAL("DEAD_HORN_CORAL", 0),
    DEAD_HORN_CORAL_BLOCK("STONE", 0),
    DEAD_HORN_CORAL_FAN("DEAD_HORN_CORAL_FAN", 0),
    DEAD_HORN_CORAL_WALL_FAN("DEAD_HORN_CORAL_WALL_FAN", 0),
    DEAD_TUBE_CORAL("DEAD_TUBE_CORAL", 0),
    DEAD_TUBE_CORAL_BLOCK("STONE", 0),
    DEAD_TUBE_CORAL_FAN("DEAD_TUBE_CORAL_FAN", 0),
    DEAD_TUBE_CORAL_WALL_FAN("DEAD_TUBE_CORAL_WALL_FAN", 0),
    DEBUG_STICK("STICK", 0),
    ...
    DIORITE("STONE", 3),
    DIORITE_SLAB("DIORITE_SLAB", 0),
    DIORITE_STAIRS("DIORITE_STAIRS", 0),
    DIORITE_WALL("DIORITE_WALL", 0),
    DIRT("DIRT", 0),
    ...
    END_STONE_BRICK_SLAB("END_STONE_BRICK_SLAB", 0),
    END_STONE_BRICK_STAIRS("END_STONE_BRICK_STAIRS", 0),
    END_STONE_BRICK_WALL("END_STONE_BRICK_WALL", 0),
    ...
    FIRE_CORAL_WALL_FAN("FIRE_CORAL_WALL_FAN", 0),
    FISHING_ROD("FISHING_ROD", 0),
    FLETCHING_TABLE("FLETCHING_TABLE", 0),
    FLINT("FLINT", 0),
    FLINT_AND_STEEL("FLINT_AND_STEEL", 0),
    FLOWER_BANNER_PATTERN("FLOWER_BANNER_PATTERN", 0),
    FLOWER_POT("FLOWER_POT_ITEM", 0),
    FOX_SPAWN_EGG("FOX_SPAWN_EGG", 0),
    FROSTED_ICE("FROSTED_ICE", 0),
    FURNACE(Arrays.asList("FURNACE", "BURNING_FURNACE"), 0),
    ...
    GLOBE_BANNER_PATTERN("GLOBE_BANNER_PATTERN", 0),
    ...
    GOLD_ORE("GOLD_ORE", 0),
    GRANITE("STONE", 1),
    GRANITE_SLAB("GRANITE_SLAB", 0),
    GRANITE_STAIRS("GRANITE_STAIRS", 0),
    GRANITE_WALL("GRANITE_WALL", 0),
    GRASS("GRASS", 0),
    GRASS_BLOCK("GRASS", 0),
    ...
    GREEN_DYE(Arrays.asList("INK_SACK", "CACTUS_GREEN"), 2),
    ...
    HONEYCOMB_BLOCK("HONEYCOMB_BLOCK", 0),
    HONEY_BLOCK("HONEY_BLOCK", 0),
    HONEY_BOTTLE("HONEY_BOTTLE", 0),
    HOPPER("HOPPER", 0),
    HOPPER_MINECART("HOPPER_MINECART", 0),
    HORN_CORAL("STONE", 0),
    HORN_CORAL_BLOCK("STONE", 0),
    HORN_CORAL_FAN("STONE", 0),
    HORN_CORAL_WALL_FAN("HORN_CORAL_WALL_FAN", 0),
    ...
    IRON_DOOR(Arrays.asList("IRON_DOOR", "IRON_DOOR_BLOCK"), 0),
    ...
    JUNGLE_DOOR("JUNGLE_DOOR_ITEM", 0),
    ...
    LAVA(Arrays.asList("LAVA", "STATIONARY_LAVA"), 0),
    ...
    LEATHER_HORSE_ARMOR("LEATHER_HORSE_ARMOR", 0),
    ...
    MINECART("MINECART", 0),
    MOJANG_BANNER_PATTERN("MOJANG_BANNER_PATTERN", 0),
    MOOSHROOM_SPAWN_EGG("MONSTER_EGG", 0),
    MOSSY_COBBLESTONE("MOSSY_COBBLESTONE", 0),
    MOSSY_COBBLESTONE_SLAB("MOSSY_COBBLESTONE_SLAB", 0),
    MOSSY_COBBLESTONE_STAIRS("MOSSY_COBBLESTONE_STAIRS", 0),
    MOSSY_COBBLESTONE_WALL("COBBLE_WALL", 1),
    MOSSY_STONE_BRICKS("SMOOTH_BRICK", 1),
    MOSSY_STONE_BRICK_SLAB("MOSSY_STONE_BRICK_SLAB", 0),
    MOSSY_STONE_BRICK_STAIRS("MOSSY_STONE_BRICK_STAIRS", 0),
    MOSSY_STONE_BRICK_WALL("MOSSY_STONE_BRICK_WALL", 0),
    ...
    OAK_SIGN("OAK_SIGN", 0),
    OAK_SLAB(Arrays.asList("WOOD_STEP", "WOOD_DOUBLE_STEP"), 0),
    OAK_STAIRS("WOOD_STAIRS", 0),
    OAK_TRAPDOOR("TRAP_DOOR", 0),
    OAK_WALL_SIGN("OAK_WALL_SIGN", 0),
    OAK_WOOD("LOG", 0),
    OBSERVER("OBSERVER", 0),
    OBSIDIAN("OBSIDIAN", 0),
    ...
    PAINTING("PAINTING", 0),
    PANDA_SPAWN_EGG("PANDA_SPAWN_EGG", 0),
    PAPER("PAPER", 0),
    ...
    PILLAGER_SPAWN_EGG("PILLAGER_SPAWN_EGG", 0),
    ...
    POLISHED_ANDESITE_SLAB("POLISHED_ANDESITE_SLAB", 0),
    POLISHED_ANDESITE_STAIRS("POLISHED_ANDESITE_STAIRS", 0),
    POLISHED_DIORITE("STONE", 4),
    POLISHED_DIORITE_SLAB("POLISHED_DIORITE_SLAB", 0),
    POLISHED_DIORITE_STAIRS("POLISHED_DIORITE_STAIRS", 0),
    POLISHED_GRANITE("STONE", 2),
    POLISHED_GRANITE_SLAB("POLISHED_GRANITE_SLAB", 0),
    POLISHED_GRANITE_STAIRS("POLISHED_GRANITE_STAIRS", 0),
    ...
    POTTED_CORNFLOWER("POTTED_CORNFLOWER", 0),
    ...
    POTTED_LILY_OF_THE_VALLEY("POTTED_LILY_OF_THE_VALLEY", 0),
    ...
    POTTED_WITHER_ROSE("POTTED_WITHER_ROSE", 0),
    ...
    PRISMARINE_WALL("PRISMARINE_WALL", 0),
    ...
    PURPUR_SLAB("PURPUR_DOUBLE_SLAB", 0),
    ...
    RAIL("RAILS", 0),
    RAVAGER_SPAWN_EGG("RAVAGER_SPAWN_EGG", 0),
    REDSTONE("REDSTONE", 0),
    REDSTONE_BLOCK("REDSTONE_BLOCK", 0),
    REDSTONE_LAMP(Arrays.asList("REDSTONE_LAMP_OFF", "REDSTONE_LAMP_ON"), 0),
    REDSTONE_ORE(Arrays.asList("REDSTONE_ORE", "GLOWING_REDSTONE_ORE"), 0),
    REDSTONE_TORCH(Arrays.asList("REDSTONE_TORCH_ON", "REDSTONE_TORCH_OFF"), 0),
    REDSTONE_WALL_TORCH("REDSTONE_TORCH_ON", 1),
    REDSTONE_WIRE("REDSTONE_WIRE", 0),
    RED_BANNER("BANNER", 1),
    RED_BED(Arrays.asList("BED", "BED_BLOCK"), 14),
    RED_CARPET("CARPET", 14),
    RED_CONCRETE("CONCRETE", 14),
    RED_CONCRETE_POWDER("CONCRETE_POWDER", 14),
    RED_DYE(Arrays.asList("ROSE_RED", "INK_SACK"), 1),
    RED_GLAZED_TERRACOTTA("RED_GLAZED_TERRACOTTA", 0),
    RED_MUSHROOM("RED_MUSHROOM", 0),
    RED_MUSHROOM_BLOCK(Arrays.asList("RED_MUSHROOM", "HUGE_MUSHROOM_1", "HUGE_MUSHROOM_2"), 0),
    RED_NETHER_BRICKS("RED_NETHER_BRICK", 0),
    RED_NETHER_BRICK_SLAB("RED_NETHER_BRICK_SLAB", 0),
    RED_NETHER_BRICK_STAIRS("RED_NETHER_BRICK_STAIRS", 0),
    RED_NETHER_BRICK_WALL("RED_NETHER_BRICK_WALL", 0),
    RED_SAND("SAND", 1),
    RED_SANDSTONE("RED_SANDSTONE", 0),
    RED_SANDSTONE_SLAB("STONE_SLAB2", 0),
    RED_SANDSTONE_STAIRS("RED_SANDSTONE_STAIRS", 0),
    RED_SANDSTONE_WALL("RED_SANDSTONE_WALL", 0),
    ...
    RED_WOOL("WOOL", 14),
    REPEATER(Arrays.asList("DIODE", "DIODE_BLOCK_OFF", "DIODE_BLOCK_ON"), 0),
    ...
    SANDSTONE_WALL("SANDSTONE_WALL", 0),
    SCAFFOLDING("SCAFFOLDING", 0),
    SCUTE("STONE", 0),
    SEAGRASS("STONE", 0),
    ...
    SKULL_BANNER_PATTERN("SKULL_BANNER_PATTERN", 0),
    ...
    SMOOTH_QUARTZ_SLAB("SMOOTH_QUARTZ_SLAB", 0),
    SMOOTH_QUARTZ_STAIRS("SMOOTH_QUARTZ_STAIRS", 0),
    SMOOTH_RED_SANDSTONE("RED_SANDSTONE", 2),
    SMOOTH_RED_SANDSTONE_SLAB("SMOOTH_RED_SANDSTONE_SLAB", 0),
    SMOOTH_RED_SANDSTONE_STAIRS("SMOOTH_RED_SANDSTONE_STAIRS", 0),
    SMOOTH_SANDSTONE("SANDSTONE", 2),
    SMOOTH_SANDSTONE_SLAB("SMOOTH_SANDSTONE_SLAB", 0),
    SMOOTH_SANDSTONE_STAIRS("SMOOTH_SANDSTONE_STAIRS", 0),
    SMOOTH_STONE("STEP", 0),
    SMOOTH_STONE_SLAB("SMOOTH_STONE_SLAB", 0),
    SNOW("SNOW", 0),
    ...
    STONE_SLAB(Arrays.asList("STEP", "DOUBLE_STEP", "DOUBLE_STONE_SLAB2"), 0),
    STONE_STAIRS("STONE_STAIRS", 0),
    ...
    SUGAR("SUGAR", 0),
    SUGAR_CANE(Arrays.asList("REEDS", "SUGAR_CANE_BLOCK"), 0),
    SUNFLOWER("DOUBLE_PLANT", 0),
    SUSPICIOUS_STEW("SUSPICIOUS_STEW", 0),
    SWEET_BERRIES("SWEET_BERRIES", 0),
    SWEET_BERRY_BUSH("SWEET_BERRY_BUSH", 0),
    ...
    TRADER_LLAMA_SPAWN_EGG("TRADER_LLAMA_SPAWN_EGG", 0),
    ...
    TUBE_CORAL_WALL_FAN("TUBE_CORAL_WALL_FAN", 0),
    ...
    WALL_TORCH("TORCH", 1),
    WANDERING_TRADER_SPAWN_EGG("WANDERING_TRADER_SPAWN_EGG", 0),
    WATER(Arrays.asList("WATER", "STATIONARY_WATER"), 0),
    ...
    YELLOW_DYE(Arrays.asList("DANDELION_YELLOW", "INK_SACK"), 11),
