...
public class v1_10_R1 implements NMS {
    ...
    public void setBlockFast(Block block, int blockId, byte data) {
        net.minecraft.server.v1_10_R1.World nmsWorld = ((org.bukkit.craftbukkit.v1_10_R1.CraftWorld) block.getWorld()).getHandle();
        net.minecraft.server.v1_10_R1.BlockPosition bp = new net.minecraft.server.v1_10_R1.BlockPosition(block.getLocation().getX(), block.getLocation().getY(), block.getLocation().getZ());
        net.minecraft.server.v1_10_R1.IBlockData ibd = net.minecraft.server.v1_10_R1.Block.getByCombinedId(blockId + (data << 12));
