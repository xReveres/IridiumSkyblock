    ...
    public void onEnable() {
        ...
        try {
            ...
            Bukkit.getScheduler().runTask(this, () -> { // Call this a tick later to ensure all worlds are loaded
                ...
                registerListeners(new EntitySpawnListener(), new LeafDecayListener(), new BlockPistonListener(), new EntityPickupItemListener(), new onPlayerTalk(), new ItemCraftListener(), new onPlayerTeleport(), new onPlayerPortal(), new BlockBreakListener(), new BlockPlaceListener(), new PlayerInteractListener(), new BlockFromToListener(), new onSpawnerSpawn(), new EntityDeathListener(), new PlayerJoinLeaveListener(), new BlockGrowListener(), new onPlayerTalk(), new PlayerMoveListener(), new EntityDamageByEntityListener(), new PlayerExpChangeListener(), new PlayerFishListener(), new EntityExplodeListener());
