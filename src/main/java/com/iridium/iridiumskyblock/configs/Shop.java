...
public class Shop {
    ...
    public List<ShopObject> shop = Arrays.asList(
            ...
            new ShopObject(XMaterial.COOKED_CHICKEN, "&9&lFood", "Food", Arrays.asList(
                    ...
                    new ShopItem(XMaterial.GOLDEN_APPLE, "&9&lGolden Apple", 10, 1000, 200, 0, 0, 12, 1),
                    new ShopItem(XMaterial.ENCHANTED_GOLDEN_APPLE, "&9&lEnchanted Golden Apple", 10, 30, 6, 0, 0, 13, 1),
