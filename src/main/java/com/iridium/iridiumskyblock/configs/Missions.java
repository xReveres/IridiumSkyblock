...
public class Missions {
    ...
    public List<Mission> missions = Arrays.asList(
            ...
            new Mission("Miner", new HashMap<Integer, MissionData>() {{
                ...
                put(2, new MissionData(5, 10000, 100, MissionType.BLOCK_BREAK, Arrays.asList(XMaterial.COAL_ORE.toString(), XMaterial.DIAMOND_ORE.toString(), XMaterial.EMERALD_ORE.toString(), XMaterial.GOLD_ORE.toString(), XMaterial.IRON_ORE.toString(), XMaterial.LAPIS_ORE.toString(), XMaterial.NETHER_QUARTZ_ORE.toString(), XMaterial.REDSTONE_ORE.toString())));
                put(3, new MissionData(10, 10000, 500, MissionType.BLOCK_BREAK, Arrays.asList(XMaterial.COAL_ORE.toString(), XMaterial.DIAMOND_ORE.toString(), XMaterial.EMERALD_ORE.toString(), XMaterial.GOLD_ORE.toString(), XMaterial.IRON_ORE.toString(), XMaterial.LAPIS_ORE.toString(), XMaterial.NETHER_QUARTZ_ORE.toString(), XMaterial.REDSTONE_ORE.toString())));
                put(4, new MissionData(15, 10000, 1000, MissionType.BLOCK_BREAK, Arrays.asList(XMaterial.COAL_ORE.toString(), XMaterial.DIAMOND_ORE.toString(), XMaterial.EMERALD_ORE.toString(), XMaterial.GOLD_ORE.toString(), XMaterial.IRON_ORE.toString(), XMaterial.LAPIS_ORE.toString(), XMaterial.NETHER_QUARTZ_ORE.toString(), XMaterial.REDSTONE_ORE.toString())));
                put(5, new MissionData(15, 10000, 2000, MissionType.BLOCK_BREAK, Arrays.asList(XMaterial.COAL_ORE.toString(), XMaterial.DIAMOND_ORE.toString(), XMaterial.EMERALD_ORE.toString(), XMaterial.GOLD_ORE.toString(), XMaterial.IRON_ORE.toString(), XMaterial.LAPIS_ORE.toString(), XMaterial.NETHER_QUARTZ_ORE.toString(), XMaterial.REDSTONE_ORE.toString())));
