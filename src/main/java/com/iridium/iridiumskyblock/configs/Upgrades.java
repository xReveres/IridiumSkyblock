...
public class Upgrades {
    ...
    public HashMap<Integer, Upgrades.OreUpgrade> ores = new HashMap<Integer, Upgrades.OreUpgrade>() {{
        put(1, new Upgrades.OreUpgrade(15, new ArrayList<>(Arrays.asList("COBBLESTONE:30", "IRON_ORE:30", "COAL_ORE:30", "DIAMOND_ORE:10")), new ArrayList<>(Arrays.asList("COBBLESTONE:30", "IRON_ORE:30", "COAL_ORE:30", "DIAMOND_ORE:10"))));
        put(2, new Upgrades.OreUpgrade(15, new ArrayList<>(Arrays.asList("COBBLESTONE:15", "IRON_ORE:40", "COAL_ORE:40", "DIAMOND_ORE:20")), new ArrayList<>(Arrays.asList("COBBLESTONE:15", "IRON_ORE:40", "COAL_ORE:40", "DIAMOND_ORE:20"))));
        put(3, new Upgrades.OreUpgrade(15, new ArrayList<>(Arrays.asList("COBBLESTONE:5", "IRON_ORE:50", "COAL_ORE:50", "DIAMOND_ORE:30")), new ArrayList<>(Arrays.asList("COBBLESTONE:5", "IRON_ORE:50", "COAL_ORE:50", "DIAMOND_ORE:30"))));
    }};
