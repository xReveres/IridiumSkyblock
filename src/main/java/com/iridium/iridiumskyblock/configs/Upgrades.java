...
public class Upgrades {
    ...
    public Upgrade<IslandUpgrade> islandSizeUpgrade = new Upgrade<>("size", true, new HashMap<Integer, IslandUpgrade>() {{
        put(1, new IslandUpgrade(15, 0, 50));
        put(2, new IslandUpgrade(15, 0, 100));
        put(3, new IslandUpgrade(15, 0, 150));
    }}, new Inventories.Item(XMaterial.GRASS_BLOCK, 10, 1, "&b&lIsland Size", Arrays.asList("&7Need more room to expand? Buy this", "&7upgrade to increase your island size.", "", "&b&lInformation:", "&b&l * &7Current Level: &b{sizelevel}", "&b&l * &7Current Size: &b{sizeblocks}x{sizeblocks} Blocks", "&b&l * &7Upgrade Cost: &b{sizecrystalscost} Crystals and ${sizevaultcost}", "&b&lLevels:", "&b&l * &7Level 1: &b50x50 Blocks", "&b&l * &7Level 2: &b100x100 Blocks", "&b&l * &7Level 3: &b150x150 Blocks", "", "&b&l[!] &bLeft Click to Purchase this Upgrade")));

    public Upgrade<IslandUpgrade> islandMemberUpgrade = new Upgrade<>("member", true, new HashMap<Integer, IslandUpgrade>() {{
    ...
    public Upgrade<IslandUpgrade> islandWarpUpgrade = new Upgrade<>("warp", true, new HashMap<Integer, IslandUpgrade>() {{
    ...
    public Upgrade<IslandOreUpgrade> islandOresUpgrade = new Upgrade<>("ores", true, new HashMap<Integer, IslandOreUpgrade>() {{
        ...
        put(3, new IslandOreUpgrade(15, 0, Arrays.asList("COBBLESTONE:30", "IRON_ORE:30", "COAL_ORE:30", "DIAMOND_ORE:30", "REDSTONE_ORE:30", "LAPIS_ORE:30", "GOLD_ORE:30", "EMERALD_ORE:30"), Arrays.asList("NETHERRACK:30", "GLOWSTONE:30", "NETHER_QUARTZ_ORE:30", "SOUL_SAND:30")));
    }}, new Inventories.Item(XMaterial.DIAMOND_ORE, 16, 1, "&b&lIsland Generator", Arrays.asList("&7Want to improve your generator? Buy this", "&7upgrade to increase your island generator.", "", "&b&lInformation:", "&b&l * &7Current Level: &b{oreslevel}", "&b&l * &7Upgrade Cost: &b{orescrystalscost} Crystals and ${oresvaultcost}", "", "&b&l[!] &bLeft Click to Purchase this Upgrade")));

    public static class Upgrade<T> {
        public String name;
        public boolean enabled;
        public Map<Integer, T> upgrades;
        public Inventories.Item item;

        public Upgrade(String name, boolean enabled, Map<Integer, T> upgrades, Inventories.Item item) {
            this.name = name;
        ...
        public IslandUpgrade getIslandUpgrade(int level) {
            T islandUpgrade = upgrades.getOrDefault(level, null);
            return islandUpgrade instanceof IslandUpgrade ? (IslandUpgrade) islandUpgrade : null;
        }
    }
