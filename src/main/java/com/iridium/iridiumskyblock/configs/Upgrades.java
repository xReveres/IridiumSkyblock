...
public class Upgrades {
    ...
    public Upgrade islandSizeUpgrade = new Upgrade("size", true, new HashMap<Integer, IslandUpgrade>() {{
    ...
    public Upgrade islandMemberUpgrade = new Upgrade("member", true, new HashMap<Integer, IslandUpgrade>() {{
    ...
    public Upgrade islandBlockLimitUpgrade = new Upgrade("blocklimit", true, new HashMap<Integer, IslandUpgrade>() {{
    ...
    public Upgrade islandWarpUpgrade = new Upgrade("warp", true, new HashMap<Integer, IslandUpgrade>() {{
    ...
    public Upgrade islandOresUpgrade = new Upgrade("ores", true, new HashMap<Integer, IslandUpgrade>() {{
