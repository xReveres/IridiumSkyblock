...
public class Upgrades {
    ...
    public Upgrade<IslandBlockLimitUpgrade> islandBlockLimitUpgrade = new Upgrade<>("blocklimit", true, new HashMap<Integer, IslandBlockLimitUpgrade>() {{
        ...
        put(3, new IslandBlockLimitUpgrade(15, 0, ImmutableMap.<XMaterial, Integer>builder().put(XMaterial.HOPPER, 100).put(XMaterial.SPAWNER, 15).build()));
